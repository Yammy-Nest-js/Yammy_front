        ...
        <div className='flex justify-around items-center h-[110%]'>
          <div className='text-center'>
            <div className='w-[60px] h-[60px] rounded-full bg-gray'>
              <CircularInput
                value={Number(CalData?.calvalue)}
                className='w-[86%] h-[86%] m-auto'
              >
                <CircularTrack strokeWidth={50} stroke='#eee' />
                <CircularProgress
                  stroke={`hsl(18, 100%, 52%)`}
                  strokeWidth={50}
                />
              </CircularInput>
              <span className='mt-[-35px] block opacity-80 text-xs'>{`${
                Number(CalData?.calvalue) * 100
              }`}</span>
            </div>
            <span>cal</span>
          </div>
          ...
          <div className='text-center'>
            <div className='w-[60px] h-[60px] rounded-full bg-gray'>
              <CircularInput
                value={Number(CalData?.fatvalue)}
                className='w-[86%] h-[86%] m-auto'
              >
                <CircularTrack strokeWidth={50} stroke='#eee' />
                <CircularProgress
                  stroke={`hsl(44, 100%, 52%)`}
                  strokeWidth={50}
                />
              </CircularInput>
              <span className='mt-[-35px] block opacity-80 text-xs'>{`${
                Number(CalData?.fatvalue) * 100
              }`}</span>
            </div>
          ...
          <div className='text-center'>
            <div className='w-[60px] h-[60px] rounded-full bg-gray'>
              <CircularInput
                value={Number(CalData?.carbovalue)}
                className='w-[86%] h-[86%] m-auto'
              >
                <CircularTrack strokeWidth={50} stroke='#eee' />
                <CircularProgress
          ...
          <div className='text-center'>
            <div className='w-[60px] h-[60px] rounded-full bg-gray'>
              <CircularInput
                value={Number(CalData?.proteinvalue)}
                className='w-[86%] h-[86%] m-auto'
              >
                <CircularTrack strokeWidth={50} stroke='#eee' />
                <CircularProgress
              ...
              <span className='mt-[-35px] block opacity-80 text-xs'>{`${
                Number(CalData?.proteinvalue) * 100
              }`}</span>
            </div>
